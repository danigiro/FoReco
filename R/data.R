...
#' Quarterly National Accounts (output, income and expenditure sides) spanning
#' the period 2000:Q1-2019:Q4.
#'
#' @usage
...
#' outside
#'
#' @format \code{outside}, \code{income} and \code{expenditure} are lists with
#' two elements:
#' \itemize{
#'   \item{\code{agg_mat} contains the \eqn{(1 \times 2)}, \eqn{(2 \times 4)},
#'   or \eqn{(6 \times 8)} aggregation matrix according to output, income or
#'   expenditure side, respectively.}
#'   \item{\code{cons_mat} contains the \eqn{(1 \times 3)}, \eqn{(2 \times 6)},
#'   or \eqn{(6 \times 14)} zero constraints matrix according to output, income
...
#' gdpconsmat
#'
#' @format \code{gdpconsmat} is the complete \eqn{(9 \times 21)} zero
...
#' the number of nights Australians spent away from home. It includes 228
#' monthly observations of Visitor Nights (VNs) from January 1998 to December
#' 2016, and has a cross-sectional grouped structure based on a geographic
#' hierarchy crossed by purpose of travel. The geographic hierarchy comprises 7
#' states, 27 zones, and 76 regions, for a total of 111 nested geographic
#' divisions. Six of these zones are each formed by a single region, resulting
#' in 105 unique nodes in the hierarchy. The purpose of travel comprises four
#' categories: holiday, visiting friends and relatives, business, and other.
#' To avoid redundancies (Girolimetto et al. 2023), 24 nodes (6 zones are
#' formed by a single region) are not considered, resulting in an unbalanced
#' hierarchy of 525 (304 bottom and 221 upper time series) unique nodes instead
#' of the theoretical 555 with duplicated nodes.
#'
#' @usage
