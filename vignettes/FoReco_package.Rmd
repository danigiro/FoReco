---
title: "`FoReco` package"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{`FoReco` package}
...
bts[[4]] <- list(ar=c(0.2,0.7), 
                 iorder=1,
                 nseasons=12)
#ARIMA(2,0,0)(0,1,1)[12]
bts[[5]] <- list(ar=c(0.65,0.15), 
                 sma=0.5, 
                 siorder=1,
                 nseasons=12)
mm <- c(11.21, 5.32, 5.63, 11.09, 5.97)
set.seed(1498)
for(i in 1:5){
  bottom[,i] <- sim_sarima(n=180, model = bts[[i]], 
                           n.start = 200, mean=mm[i])
}
...
#> thf: 000  (889.8447)  (152.9091)  
#> thf: 001  (1618.449)  (203.5812)  
#> thf: 002  (41.70141)  (18.00942)  
#> thf: 003  (4.628213)  (1.114163)  
#> thf: 004  (0.645749)  (0.4403413)  
#> thf: 005  (0.04443641)  (0.07427121)  
#> thf: 006  (0.02476911)  (0.01553138)  
#> thf: 007  (0.004455397)  (0.003033694)  
#> thf: 008  (0.0008590561)  (0.0005690921)  
#> thf: 009  (0.0001857843)  (0.0001105291)  
#> thf: 010  (3.441299e-05)  (2.066428e-05)  
#> thf: Convergence (starting from thf) achieved at iteration number 11! 
#> thf: Temporal incoherence 3.869257e-06 < 1e-05 tolerance
#> ---------------------------------------
```
...
* Heuristic first-temporal-then-cross-sectional cross-temporal reconciliation using *t-acov + cs-shr* (Kourentzes and Athanasopoulos, 2019)
```{r eval=FALSE}
...
Nystrup, P., Lindström, E., Pinson, P. e Madsen, H. (2020). «Temporal hierarchies with autocorrelation for load forecasting». In: _European Journal of Operational Research_,  280, 3, pp. 876–888.

Wickramasuriya, S.L., Athanasopoulos, G., Hyndman, R.J. (2019), Optimal forecast reconcilia- tion for hierarchical and grouped time series through trace minimization, _Journal of the American Statistical Association_, 114, 526, 804-819.
