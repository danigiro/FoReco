...
knitr::include_graphics("https://raw.githubusercontent.com/danigiro/FoReco/refs/heads/master/vignettes/articles/images/infoVN.png")
``` 
...
```{r dpi=300, out.width = '90%', fig.align='center', fig.show="hold", fig.dim = c(12, 8)}
#| label: "data"
# Dataset
data(vndata) 
str(vndata)
...
knitr::include_graphics("https://raw.githubusercontent.com/danigiro/FoReco/refs/heads/master/vignettes/articles/images/bal_unb.png")
``` 
