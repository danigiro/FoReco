...
base_tejb <- teboot(model, B, m)$sample
dim(base_tejb)
reco_tejb <- tesample(base_tejb, agg_order = m, res = res_vec, nn = "sntz", comb = "sar1")
...
reco_teg_sar1 <- tegauss(base = base_vec, agg_order = m, comb = "sar1", res = res_vec)
...
reco_teg <- tegauss(base = base_vec, agg_order = m, comb = "sar1", 
...
reco_tes <- tesample(base_tes, agg_order = m, res = res_vec, nn = "sntz", comb = "sar1")
