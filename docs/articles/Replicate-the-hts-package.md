...
[`htseg2`](https://pkg.earo.me/hts/reference/htseg1.html) dataset (a
simulated four level hierarchy with a total of 17 series, each of length
16) of the [`hts`](https://pkg.earo.me/hts) package is used to show how
to get the same results using
[`FoReco`](https://danigiro.github.io/FoReco).
...
[`hts`](https://pkg.earo.me/hts) and
[`FoReco`](https://danigiro.github.io/FoReco) packages and we show the
equivalence between them. We explore bottom-up, top-down, and optimal
...
#> 'a' is computationally singular, min(d)/max(d)=1.13234e-16, d=abs(diag(U))
